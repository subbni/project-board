...
class ArticleServiceTest {
    ...
    @DisplayName("검색어 없이 게시글을 검색하면 게시글 리스트를 리턴한다.")
    @Test
    void givenNoSearchParams_whenSearchingArticles_thenReturnsArticleList() {
        // Given
    ...
    @DisplayName("검색어와 함께 게시글을 검색하면 게시글 리스트를 리턴한다.")
    @Test
